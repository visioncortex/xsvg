...
- **`<x:pie>`** / **`<x:slice>`** — pie / donut / polar-area charts: per-slice angle, radius, explode ([§7.8](Specification.md))
- **`<x:plot>`** / **`<x:bars>`** / **`<x:line>`** — a linear data coordinate frame for bar & line charts ([§7.9](Specification.md))
